        ...
        <div class="col-xs-12">
            ...
            <div class="row centerall">
                <div class="col-xs-12">
                    <div style="transform:skew(-20deg); background:#007FC5;padding:15px 45px;display: inline-block;">
                        <h1 class="center" style="color:white;margin:0px;transform:skew(20deg); "><span class="light">Find</span>
            ...
            <div class="row">
                <div class="col-xs-12  col-sm-4  push-down-30">
                    ...
                    <span class="glyphicon  glyphicon-envelope"></span> <a class="secondary-link"
                                                                          href="mailto:contact@charlieschopstics.com"><strong>contact@charlieschopstics.com</strong></a>
                ...
                <div class="col-xs-12  col-sm-8" style="margin-bottom:20px;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d2907.324799416611!2d-79.8838397!3d43.223649400000006!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882c9afc9113aa47%3A0xb155b54bab6e44be!2s970+Upper+James+St%2C+Hamilton%2C+ON+L9C+3A6!5e0!3m2!1sen!2sca!4v1414366075691"
                        width="100%" height="400" frameborder="0" style=" border:2px solid #dadada;"></iframe>
                </div>
            </div>

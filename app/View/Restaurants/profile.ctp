    ...
    <div class="col-xs-12" >
        <div class=""  style="margin-bottom:-13px;">
            <div class="banners--big" style="padding:10px;">
                Charlie's Chopsticks Online Ordering            </div>
        </div>
    </div>
</div>
        ...
        <div class="shop-filter">
            ...
            <ul class="nav  nav--filter">
                ...
                if($res['Combo'])
                {
                    ...
                    <li><a href="#combo" class="scrolly"><div class="col-xs-6" style="padding-left: 0;">Combo</div><div class="col-xs-6"><img  src="<?php echo $this->webroot;?>images/menus/default_combo.png" class="catimage"  /></div><div class="clearfix"></div></a></li>
                <?php
                }
                ?>
                ...
                if($res['MenuCategory'])
                {
                    foreach($res['MenuCategory'] as $mc)
                    {
                        ...
                        <li><a href="#category<?php echo $mc['id'];?>" class="scrolly">
                                ...
                                <div class="col-xs-6"><img  src="<?php echo $this->webroot;?>images/category/<?php echo $mc['cat_image'];?>" class="catimage"  /></div>
...
<div class="col-xs-12 col-sm-8 menuparent" style="border:1px solid #e4e4e4;padding:10px;background:#fff;margin-bottom:10px;">
<?php
if($closed)
{
    ?>
...
foreach($res['Combo'] as $cat)
{
    ...
    <div class="col-sm-4" style="margin-bottom:1px; padding:10px;background: #fcfcfc;border:1px solid #f4f4f4;border-bottom:5px solid #efefef;">
        ...
        ?>
        <br />
        <div class="col-sm-10" style="padding:0 10px;"><strong id="combo<?php echo $cat['id'];?>"><a href="#Combo<?php echo $cat['id'];?>" role="button" data-toggle="modal"><?php echo $cat['title'];?></a></strong></div><div class="col-sm-2"><a href="#Combo<?php echo $cat['id'];?>" role="button" data-toggle="modal"><span class="glyphicon glyphicon-move"></span></a></div>
        ...
        for($ccd=0;$ccd<$qty[$me['Menu']['id']];$ccd++)
        {
            ...
            <div style="margin-bottom: 10px;border:1px solid #eee;border-bottom:5px solid #eee;">
                ...
                <div class="subitems_<?php echo $cat['id'];?> optionals" style="position: static;<?php if(!$submenuscat){?>display:none;<?php }?>border:none;" >
                    <?php if($cntr == 0){$cntr++;?>
                        <input type="checkbox" class="chk" value="" title="<?php echo $cat['id']."_[".$cat['title']."]-_".$cat['price']."_"."";?>" checked="checked" style="display: none;" />
                    <?php }?>
                    <div class="clearfix space10"></div>
                    <input type="checkbox" class="chk" value="" title="<?php echo $me['Menu']['id']."_".$me['Menu']['menu_item']."-_0_"."";?>" checked="checked" style="display: none;" />
                    <?php
    ...
    foreach($cat['Menu'] as $ks=>$me)
    {
        ...
        <div class="menucl menu-title" style="text-align: center;">
            ...
            <div class="menucl" style="">
                <?php if(count($submenuscat)>0){?>
                    <a href="#Modal<?php echo $me['id'];?>" role="button" data-toggle="modal">
                        <center><img class="i menutileimg" src="<?php if($me['image']&& file_exists(APP."webroot/images/menus/".$me['image'])){echo $this->webroot;?>images/menus/<?php echo $me['image'];}else{echo $this->webroot.'images/default.png';}?>"/></center>
                    </a>
                <?php }
                else
                {?>
                    <a href="javascript:void(0);"  class="add_menu_profile " id="profilemenu<?php echo $me['id'];?>">
                        <center><img class="i menutileimg" src="<?php if($me['image']&& file_exists(APP."webroot/images/menus/".$me['image'])){echo $this->webroot;?>images/menus/<?php echo $me['image'];}else{echo $this->webroot.'images/default.png';}?>"/></center>
                    </a>
                <?php }?>
            </div>
            ...
            <?php if(count($submenuscat)>0){?>
                ...
                <div>
                    <div class="col-xs-12 col-sm-9" style="padding: 0;"><a href="#Modal<?php echo $me['id'];?>" role="button" data-toggle="modal"><strong><?php echo $me['menu_item'];?></strong>: $<span class="profileprice<?php echo $me['id'];?>"><?php echo $pr;?></span></a></div>
                    <div class="col-xs-12 col-sm-3"><a href="#Modal<?php echo $me['id'];?>" role="button" data-toggle="modal"><span class="glyphicon glyphicon-move"></span></a></div>
                    <div class="clearfix"></div>
                </div>
            <?php
            }
            else
            {
                ?>
                <div>
                    <div class="col-xs-12 col-sm-9" style="padding: 0;"><a href="javascript:void(0);"  class="add_menu_profile " id="profilemenu<?php echo $me['id'];?>">
                            <strong><?php echo $me['menu_item'];?></strong>: $<span class="profileprice<?php echo $me['id'];?>"><?php echo $pr;?></span></a>
                    </div>
                    <div class="col-xs-12 col-sm-3"><a href="#Modal<?php echo $me['id'];?>" role="button" data-toggle="modal"><span class="glyphicon glyphicon-move"></span></a></div>
                    <div class="clearfix"></div>
                </div>
        ...
        foreach($submenuscat as $subm)
        {
            $ch++;?>
                            ...
                            <input type="checkbox" class="chk" checked="checked" style="display: none;" id="<?php echo $subm['MenuCategory']['id'];?>" title="___" value="<?php echo $subm['MenuCategory']['title'];?>" />
                            <a href="javascript:void(0);" <?php /*onclick="$($(this).parent().children('div:eq(0)')).toggle('slow'); $('.extra-<?php echo $subm['MenuCategory']['id'];?>').each(function(){$(this).removeAttr('checked');}) "*/?> ><strong><?php echo $subm['MenuCategory']['title'];?></strong></a>
                              <br />
							<span>
            ...
            foreach($subm['Menu'] as $k=>$m)
            {
                //if($k%3 == 0 ){?>
                                ...
                                <?php //}?>
                                        <?php if($subm['MenuCategory']['is_multiple']=='1'){?>
                                       <div class="col-xs-12 "  style="padding-left:0px;" >
                                            <input type="checkbox" value="" name="extra" class="extra-<?php echo $subm['MenuCategory']['id'];?>" title="<?php echo $m['id']."_".$m['menu_item']."_".$m['price']."_".$subm['MenuCategory']['title'];?>" id="extra_<?php echo $m['id'];?>" />&nbsp;&nbsp;<?php if($m['price'])echo $m['menu_item']."  (+ $".number_format(str_replace('$','',$m['price']),2).")";else{echo $m['menu_item']."  (+ $".number_format(str_replace('$','','0.00'),2).")";}?>
                                       </div> 
                                       <?php }else
            {?>
                                        <div class="col-xs-12 " style="padding-left:0px;" >
                                            <input type="radio" value="" name="extra_<?php echo $subm['MenuCategory']['id'];?>" class="extra-<?php echo $subm['MenuCategory']['id'];?>" title="<?php echo $m['id']."_".$m['menu_item']."_".$m['price']."_".$subm['MenuCategory']['title'];?>" id="extra_<?php echo $m['id'];?>" />&nbsp;&nbsp;<?php if($m['price'])echo $m['menu_item']."  (+ $".number_format(str_replace('$','',$m['price']),2).")";else{echo $m['menu_item']."  (+ $".number_format(str_replace('$','','0.00'),2).")";}?>
                                        </div> 
                                       <?php
            }?>
                                 <?php
        ...
        <form action="<?php echo $this->webroot;?>restaurants/order/<?php echo $res['Restaurant']['id'];?><?php if($order){?>/<?php echo $order['Reservation']['id']; }?>" method="post" onsubmit="if($('input.subtotal').val()=='0.00'){$('.error_order').show(function(){$('.error_order').fadeOut(5000);});return false;}else if( (Number($('input.subtotal').val()) < Number(<?php echo $res['Restaurant']['min_delivery'];?>) ) && $('input[name=order_type]:checked').val()== 'delivery' ){ $('.error_delivery').show(function(){$('.error_delivery').fadeOut(5000);});return false;}">
            ...
            <div class="tab-content">
                ...
                <div id="" class="">
                    ...
                    <div class="orders" id="clearorder" <?php if($order && count($arr_m)>0){?>style="overflow-y:scroll;height:260px;"<?php }?>>
                        ...
                        if($order)
                        {
                            ...
                            foreach($arr_m as $k=>$me)
                            {
                                ...
                                <div id="list<?php echo $list_ids[$k];?>" class="infolist">
                                    <strong class="namemenu"><?php echo str_replace(":",": ",$tt)." ".$x;?></strong>
                                    <div class="left">
                    ...
                    <div class="submits">
                        <div style="float:left;"><input <?php if($closed){?>disabled="disabled"<?php }?> type="submit" value="Submit Order" class="btn btn-success" style="font-size:11px !important;margin-bottom:5px;margin-right:10px;width:131px;" /></div>
                        <div style="float:left;"><a href="" class="btn btn-notice" style="color: #777;border:1px solid #ddd;width:131px;margin-bottom: 5px;font-size:11px">Start Over</a></div>
                        <div class="clearfix"></div>

        <div style="color:#666;">
        Hello,<br/><br/>
                You've received a new order from Charlie's Chopstick. Please click <a href="<?php echo $base_url;if($base_url[strlen($base_url)-1]!='/'){?>/<?php }?>orders/pending">here</a> to view your order.
        </div>

...
<div class="dashboard toprint" style="border:1px solid #efefef;">
    <div class="test">
        <center>
    ...
    <?php
        if ($this->params['action'] == 'view') {
            ...
            <div class="infolist noprint">
                ...
                <?php $date = new DateTime($order['Reservation']['order_time']);
            ...
            <div class="infolist noprint">
                ...
                <?php if (!$order['Reservation']['order_now']) {
                    if ($order['Reservation']['order_till']) {
                        $date = new DateTime($order['Reservation']['order_till']);
                        echo $date->format('l jS \of F Y h:i:s A');
                    }
                } else { ?>
                    Order now
            ...
            if ($order['Reservation']['order_type'] == 'delivery') {
                ...
                <div class="infolist noprint">
                    ...
                    <?php if ($order['Reservation']['address1']) {
                        echo $order['Reservation']['address1'] . ', ';
                    }
                        if ($order['Reservation']['address2']) {
                            echo $order['Reservation']['address2'] . ', ';
                        }
                        if ($order['Reservation']['city']) {
                            echo $order['Reservation']['city'] . ', ';
                        }
                        if ($order['Reservation']['province']) {
                            echo $order['Reservation']['province'] . ', ';
                        }
                        if ($order['Reservation']['postal_code']) {
                            echo $order['Reservation']['postal_code'];
                        }?>
                </div>
            <?php
            }
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php $cash = array('Debit/Credit', 'Cash');
                            echo $cash[$order['Reservation']['cash_type']]; ?>
